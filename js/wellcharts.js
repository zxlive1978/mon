...
$(function() {
  ...
  for (var t = 0; t < numbs916; t++){
	...
	mlrx1=((d916[t]["mltx"]))/1;
	mltx1=((d916[t]["mlrx"]))/1;
	data10.push({x: d916[t]["date"]/1,  y: Math.log10(rx1) });
...
$(function() {
  ...
  for (var t = 0; t < numbs4450; t++){
	...
	data12.push({x: d4450[t]["date"]/1,  y: Math.log10(rx1) });
...
$(function() {
  ...
  for (var t = 0; t < numbs631; t++){
	...
	ml1=(100*(d631[t]["ml"]))/1;
	data14.push({x: d631[t]["date"]/1,  y: Math.log10(rx1) });
...
$(function() {
  ...
  for (var t = 0; t < numbs110; t++){
	...
	mlrx1=((d110[t]["mltx"]))/1;
	mltx1=((d110[t]["mlrx"]))/1;
	data16.push({x: d110[t]["date"]/1,  y: Math.log10(rx1) });
...
$(function() {
  ...
  ml1=(100*(d224[t]["ml"]))/1;
	...
	data18.push({x: d224[t]["date"]/1,  y: Math.log10(rx1) });
...
$(function() {
  ...
  for (var t = 0; t < numbs908; t++){
	...
	mltx1=((d908[t]["mlrx"]))/1;
	ml1=(100*(d908[t]["ml"]))/1;
	data20.push({x: d908[t]["date"]/1,  y: Math.log10(rx1) });
...
$(function() {
  ...
  for (var t = 0; t < numbs411; t++){
	...
	mltx1=((d411[t]["mlrx"]))/1;
	ml1=(100*(d411[t]["ml"]))/1;
	data8.push({x: d411[t]["date"]/1,  y: Math.log10(rx1) });
...
$(function() {
  ...
  for (var t = 0; t < numbs89; t++){
	...
	mltx1=((d89[t]["mlrx"]))/1;
	ml1=(100*(d89[t]["ml"]))/1;
	data34.push({x: d89[t]["date"]/1,  y: Math.log10(rx1) });
...
$(function() {
  ...
  for (var t = 0; t < numbs83; t++){
	...
	mltx1=((d83[t]["mlrx"]))/1;
	ml1=(100*(d83[t]["ml"]))/1;
	data34.push({x: d83[t]["date"]/1,  y: Math.log10(rx1) });
...
$(function() {
  ...
  for (var t = 0; t < numbs401; t++){
	...
	mltx1=((d401[t]["mlrx"]))/1;
	ml1=(100*(d401[t]["ml"]))/1;
	data34.push({x: d401[t]["date"]/1,  y: Math.log10(rx1) });
...
$(function() {
  ...
  for (var t = 0; t < numbs610; t++){
	...
	mltx1=((d610[t]["mlrx"]))/1;
	ml1=(100*(d610[t]["ml"]))/1;
	data34.push({x: d610[t]["date"]/1,  y: Math.log10(rx1) });
...
$(function() {
  ...
  for (var t = 0; t < numbs627; t++){
	...
	mltx1=((d627[t]["mlrx"]))/1;
	ml1=(100*(d627[t]["ml"]))/1;
	data34.push({x: d627[t]["date"]/1,  y: Math.log10(rx1) });
...
$(function() {
  ...
  for (var t = 0; t < numbs544; t++){
	...
	mltx1=((d544[t]["mlrx"]))/1;
	ml1=(100*(d544[t]["ml"]))/1;
	data34.push({x: d544[t]["date"]/1,  y: Math.log10(rx1) });
