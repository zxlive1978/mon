...
#628
#threading.Thread(target=read_well, args=["192.168.146.3","s110"]).start()
t628 = Process(target=read_well, args=["192.168.146.195","s630"])
t628.start()
t628.join(10)
if t628.is_alive(): t628.terminate()


#629
#threading.Thread(target=read_well, args=["192.168.146.3","s110"]).start()
t629 = Process(target=read_well, args=["192.168.146.18","s629"])
t629.start()
t629.join(10)
...
#6611
#threading.Thread(target=read_well, args=["192.168.146.3","s110"]).start()
t6611 = Process(target=read_well, args=["192.168.146.35","s4450"])
t6611.start()
t6611.join(10)
if t6611.is_alive(): t6611.terminate()
