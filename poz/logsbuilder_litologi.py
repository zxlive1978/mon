					...
					if (geolog[0]==interval[0]):
						...
						for type_lith in data1:
							...
							if (type_lith[1]==interval[0]):
								print 'id:'+cur_rec[0]+' order:'+cur_rec[5]+' lith:'+cur_rec[6]+' %:'+str(round(float(cur_rec[7]),2)) + '  geology:'+ geolog[1]+' top:'+str(round(float(interval[6]),2))+' bot:'+str(round(float(interval[7]),2))+' type:'+type_lith[0]
