...
def speed(host,port,delay):
	try:
		...
		telnet.write("cat /sys/class/net/br0/statistics/rx_bytes; sleep "+ str(delay)+"; cat /sys/class/net/br0/statistics/rx_bytes\n ")
		telnet.write("exit\n")
		...
		telnet.write("superzxmn\n")
		telnet.read_until("~ #",timeout=delay+4)
		telnet.write("cat /sys/class/net/br0/statistics/tx_bytes; sleep "+ str(delay)+"; cat /sys/class/net/br0/statistics/tx_bytes\n ")
		telnet.write("exit\n")
		data =telnet.read_all()
		data= data.splitlines()
		oldtx=float(data[1])
