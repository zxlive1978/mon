...
function init(){
	...
	*/
	...
	var stepMin = 10; //Шаг значения 10 минут
	//Сколько целых минут?
	...
	*/
	...
	for (var i = 0; i < ten_minuts; i++){
		...
		if (big_teth) {
			var day = new Date(startTime.getTime() + Math.floor(i* stepMin* 60 *1000));
